...
rCollimator=5
CaloDistance=56
SFStatus=true  # is the Scintillator finger in the the beam or not? true/false
StrawStatus=${2}
LanexStatus=${3}
Xposition=${4}
eKin=60
...
outFile=${SetUp}_${outType}_NBunch_${NBunch}_E_${eKin}_pm_${sigmaE}MeV_sz_${spotSize}_mm_div_${div}_rad_ePol_${ePol}_rCollimator_${rCollimator}_mm_CaloDistance_${CaloDistance}_cm_SF_${SFStatus}_Lanex_${LanexStatus}_Straw_${StrawStatus}_Xpos_${Xposition}_mm.root
#set the environment
