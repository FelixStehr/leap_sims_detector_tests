...
outFile=${SetUp}_${outType}_NBunch_${NBunch}_E_${eKin}_pm_${sigmaE}MeV_sz_${spotSize}_mm_div_${div}_rad_ePol_${ePol}_rCollimator_${rCollimator}_mm_CaloDistance_${CaloDistance}_cm_SF_${SFStatus}_Lanex_${LanexStatus}_Straw_${StrawStatus}_Xpos_${Xposition}_mm
#set the environment
...
mv run0_$outFile.gdml /nfs/dust/ilc/user/fstehr/leap_sims/results/simulation_$simNo/run0_${outFile}.gdml
